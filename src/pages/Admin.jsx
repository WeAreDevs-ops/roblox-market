...
export default function Admin() {
  ...
  const handleLimitedSubmit = async () => {
    if (!limitedForm.assetId || !limitedForm.price || !limitedForm.contact || !seller?.username) {
    ...
    if (res.ok) {
      Swal.fire('Success', limitedEditMode ? 'Listing updated' : 'Listing added', 'success');
      setLimitedForm({ assetId: '', price: '', contact: '', seller: '' });
